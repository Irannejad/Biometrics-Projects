...
[vec_mat,val_d_mat] = eigs(C,50); %returns a diagonal matrix of eigenvalues and a matrix V whose columns are the corresponding eigenvectors.
...
for i = 1:50
    ...
    coefs_mat(:,i) = transpose(vec_mat) * (double(mat_images_50(:,i)- mean_face(:,1))); % 50x1 = 900x50 *(900x1 - 900x1)
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
